...
bool ImGui::ButtonEx2(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    window->DrawList->AddRectFilledMultiColor(bb.Min, bb.Max, ImColor(0.20f, 0.14f, 0.70f, 1.f), ImColor(0.44f, 0.21f, 0.98f, 1.f), ImColor(0.44f, 0.21f, 0.98f, 1.f), ImColor(0.20f, 0.14f, 0.70f, 1.f));
...
bool ImGui::ScrollbarEx(const ImRect& bb_frame, ImGuiID id, ImGuiAxis axis, float* p_scroll_v, float size_avail_v, float size_contents_v, ImDrawFlags flags)
{
    ...
    window->DrawList->AddRectFilled(bb_frame.Min, bb_frame.Max, bg_col, 9.f/*, flags*/);
    ImRect grab_rect;
    if (axis == ImGuiAxis_X)
...
bool ImGui::ImageButtonEx(ImGuiID id, ImTextureID texture_id, const ImVec2& size, bool background, const ImVec2& uv0, const ImVec2& uv1, const ImVec2& padding, const ImVec4& bg_col, const ImVec4& tint_col)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
...
bool ImGui::ImageButton(ImTextureID user_texture_id, const ImVec2& size, bool background, const ImVec2& uv0, const ImVec2& uv1, int frame_padding, const ImVec4& bg_col, const ImVec4& tint_col)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    if (window->SkipItems)
    ...
    return ImageButtonEx(id, user_texture_id, size, background, uv0, uv1, padding, bg_col, tint_col);
}
